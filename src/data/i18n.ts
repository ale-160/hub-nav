...
export const STRINGS_ZH = {
  ...
  serverConfigUrlPlaceholder: 'https://your-domain.com/config.json',
  serverConfigUrlDesc: '服务器上默认配置文件的 URL 地址',
  serverConfigStatus: '状态',
  serverConfigConfigured: '已配置',
  serverConfigNotConfigured: '未配置',
  serverConfigTestConnection: '测试连接',
  serverConfigTesting: '测试中...',
  serverConfigTestSuccess: '连接成功',
  serverConfigTestFailed: '连接失败',
  serverConfigApply: '使用服务器配置',
  serverConfigApplyDesc: '使用服务器配置覆盖本地配置',
  serverConfigHasLocal: '存在本地配置',
  serverConfigNoLocal: '无本地配置',
  serverConfigWarning: '警告',
  serverConfigOverwriteConfirm: '这将覆盖您当前的本地配置，是否继续？',
  serverConfigApplied: '服务器配置应用成功',
  serverConfigApplyFailed: '应用服务器配置失败',
  serverConfigClearUrl: '清除 URL',
  serverConfigVersion: '版本',
  serverConfigSync: '启用云端同步',
  serverConfigSyncDesc: '每次打开页面时自动从云端同步配置',
  serverConfigSyncEnabled: '云端同步已启用',
  serverConfigSyncDisabled: '云端同步未启用',
  serverConfigSyncSuccess: '同步成功',
  serverConfigSyncFailed: '同步失败',
  ...
  importJsonDesc: '导入之前导出的配置文件',
  useUrl: '使用 URL',
  useUrlDesc: '从远程 URL 加载配置（支持云端同步）',
  enterConfigUrl: '输入配置 URL',
  enterConfigUrlDesc: '提供一个完整的 JSON 配置文件 URL 地址（需包含 https://）',
  setupComplete: '设置完成',
  back: '返回',
...
export const STRINGS_EN = {
  ...
  serverConfigUrlPlaceholder: 'https://your-domain.com/config.json',
  serverConfigUrlDesc: 'URL to the default configuration file on the server',
  serverConfigStatus: 'Status',
  serverConfigConfigured: 'Configured',
  serverConfigNotConfigured: 'Not Configured',
  serverConfigTestConnection: 'Test Connection',
  serverConfigTesting: 'Testing...',
  serverConfigTestSuccess: 'Connection successful',
  serverConfigTestFailed: 'Connection failed',
  serverConfigApply: 'Use Server Config',
  serverConfigApplyDesc: 'Replace local configuration with server configuration',
  serverConfigHasLocal: 'Local configuration exists',
  serverConfigNoLocal: 'No local configuration',
  serverConfigWarning: 'Warning',
  serverConfigOverwriteConfirm: 'This will replace your current local configuration. Continue?',
  serverConfigApplied: 'Server configuration applied successfully',
  serverConfigApplyFailed: 'Failed to apply server configuration',
  serverConfigClearUrl: 'Clear URL',
  serverConfigVersion: 'Version',
  serverConfigSync: 'Enable Cloud Sync',
  serverConfigSyncDesc: 'Automatically sync configuration from cloud every time you open the page',
  serverConfigSyncEnabled: 'Cloud sync enabled',
  serverConfigSyncDisabled: 'Cloud sync disabled',
  serverConfigSyncSuccess: 'Sync successful',
  serverConfigSyncFailed: 'Sync failed',
  ...
  importJsonDesc: 'Import a previously exported configuration file',
  useUrl: 'Use URL',
  useUrlDesc: 'Load configuration from a remote URL (supports cloud sync)',
  enterConfigUrl: 'Enter Configuration URL',
  enterConfigUrlDesc: 'Provide a complete URL to a JSON configuration file (must include https://)',
