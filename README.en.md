...
│   │   └── builtinIcons.ts    # Built-in icon library
...
├── books/                     # Documentation and test reports
├── package.json
├── tsconfig.json
└── next.config.ts
```
